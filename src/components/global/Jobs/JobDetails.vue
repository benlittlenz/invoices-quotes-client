...
<div class="bg-white relative">
        <div class="flex">
            <div class="flex-col border-r mt-16 pl-5 w-1/5 bg-gray-100">
                <div class="flex ml-3 py-8">
                    <div class="h-8 w-8 rounded">
                        <img class="h-8 w-12 mt-1 rounded " src="https://www.noeticitservices.com/images/hero-img05.png">
                    </div>
                    <div class="flex-col">
            ...
            <div class="flex w-4/5 mt-24">
                <div class=" ml-10" style="width: 400px">
                    ...
                    <div class="flex overflow-auto" style="height: 350px">
                        <div class="mr-10" style="width: 458px">
                            ...
                            <div class="items-center flex py-1 mt-5 text-sm font-medium text-gray-800">
                                <img class="h-10 w-10 rounded-full mr-8" src="https://media-exp1.licdn.com/dms/image/C4E03AQH5UhdTI6_h4A/profile-displayphoto-shrink_200_200/0?e=1600300800&v=beta&t=eK7436PgWU4lW83_6HsuePxHj1LpJW-M-1blsqreoV4">
                                ...
                                <div class="flex-col">
                                    <div class="flex-col mt-3 rounded">
                                        ...
                                        <div class="flex px-2 py-2 hover:bg-gray-200">
                                            <img class="w-6 h-6 rounded-full" src="https://media-exp1.licdn.com/dms/image/C4E03AQH5UhdTI6_h4A/profile-displayphoto-shrink_200_200/0?e=1600300800&v=beta&t=eK7436PgWU4lW83_6HsuePxHj1LpJW-M-1blsqreoV4" alt="" />
                                    ...
                                    <div class="flex-col mt-3 rounded">
                                        ...
                                        <div class="flex px-2 py-2 hover:bg-gray-200">
                                            <img class="w-6 h-6 rounded-full" src="https://www.noeticitservices.com/images/nitish.jpg" alt="" />
                                            <div class="font-normal text-gray-700 ml-3 text-xs">
                                                Nitish Kumar
                                            </div>
                                        </div>
